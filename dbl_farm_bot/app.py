...
class BotGui:
    ...
    def _build_window(self) -> None:
        ...
        ttk.Label(sidebar, textvariable=self.active_event_var, style="Hero.TLabel", wraplength=210).pack(anchor="w", pady=(4, 16))
        ...
        ttk.Label(event_card, text="Events are farmed from top to bottom.", style="Muted.TLabel").pack(anchor="w", pady=(0, 8))
